...
excerpt: '<div style="text-align: justify "> This paper analyzes how carbon risks affect the stochastic discount factor (SDF). The consumption-based carbon risk measure is based on information on aggregate consumption and carbon footprint for each good and service. The consumption growth is decomposed into two components- the growth rate of carbon consumption component and the growth rate of the share of carbon consumption out of total consumption. A long run risks model is developped where the SDF is affected by the green and carbon shocks through the consumption. I show that the long-run risk in the consumption growth comes mainly from the carbon consumption growth due to policy to curb the emission. Using a long-run risks model, I find that the SDF is affected by both the green and carbon shocks of the consumption. Moreover, my long-run carbon consumption risks model replicates the observed equity premium, volatility and risk-free rate by decomposing and help explaining the cross-section of returns. </div>'
date: 2021-10-01
venue: 'Working paper'
...
---
<!-- <div style="text-align: justify "> This paper analyzes how carbon risks affect the stochastic discount factor (SDF). The consumption-based carbon risk measure, I use information on aggregate consumption and carbon footprint for each goods and services. Then I decompose the consumption growth into two components- the growth rate of carbon consumption component and the growth rate of the share of carbon consumption out of total consumption. I show that the long-run risk in the consumption growth comes mainly from the carbon consumption growth due to policy to curb the emission. Using a long-run risks model, I find that the SDF is affected by both the green and carbon shocks of the consumption. Moreover, my long-run carbon consumption risks model replicates the observed equity premium, volatility and risk-free rate by decomposing and help explaining the cross-section of returns. My model increases the ability of the investors to detect the long-run risk. Namely, investors can profit from it by using climate change news. In terms of policy, one should encourage households to consume more green which is equivalent in terms of the policy to encourage firms to produce green.</div> -->
